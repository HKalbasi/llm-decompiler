...
دارند و چالش خاصی در این وظیفه برای آن‌ها وجود ندارد.
...
از روی کد زبان ماشین است که در پژوهش‌های پیشین نیز انجام شده است.
@SALT4Decompile

برای این کار کافیست که دستورهای زبان ماشین به دو دسته پرش کننده و بدون
پرش تقسیم شوند. هدف‌های پرش در دستورات پرشی بلوک‌های ساده جدید می‌سازند و
خود دستورات پرشی خاتمه‌دهنده‌های بلوک‌های ساده خواهند بود. دستورهای غیر
پرشی نیز دستورهای بلوک ساده را تشکیل می‌دهند و صرفا باید به دستورهای تعریف‌شده
...
پشتیبانی می‌کند که برای کاربرد بررسی ما بسیار مفید است.
@z3
