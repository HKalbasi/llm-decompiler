...
نسبت به اسلید و دیپ‌سیک‌کدر خام به دست آورده است @llm4decompile.
...
کد قابل اجرا نباشد @Hallucinations.
...
که در حال مطالعه این بدافزار است را گمراه کند @Prompt_injection.
